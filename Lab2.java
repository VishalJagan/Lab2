public class Lab2 {
	...
	System.out.println("I met a man with seven wives"); //Trick question: Were the man/wives/cats/kits all going to St. Ives or just the narrator?
	...
	if (manGoingToStIves) {
	    ...
	    total = (int)numWives * numSacksPerWife * numCatsPerSack * numKitsPerCat + 2; //The plus is 1 for narrator and 1 for the man
	} else {
